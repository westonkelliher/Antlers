...
// The Scene_Component superclass is the base class for any scene part or code snippet that you can add to a
...
// Canvas_Widget embeds a WebGL demo onto a website, along with various panels of controls.
// Standards say compliant browsers support up to 16 WebGL contexts per page.
class Canvas_Widget {
    ...
    create(element, scenes) {
        ...
        try {
            this.populate_canvas(element, scenes);
        } catch (error) {
...
window.Mat4 = window.tiny_graphics.Mat4 = Mat4;

window.Color = window.tiny_graphics.Color = Color;
window.Light = window.tiny_graphics.Light = Light;
window.Shape = window.tiny_graphics.Shape = Shape;

window.Code_Manager = window.tiny_graphics.Code_Manager = Code_Manager;
window.Keyboard_Manager = window.tiny_graphics.Keyboard_Manager = Keyboard_Manager;
window.Canvas_Manager = window.tiny_graphics.Canvas_Manager = Canvas_Manager;
window.Graphics_State = window.tiny_graphics.Graphics_State = Graphics_State;

window.Shader = window.tiny_graphics.Shader = Shader;
window.Texture = window.tiny_graphics.Texture = Texture;
window.Vertex_Buffer = window.tiny_graphics.Vertex_Buffer = Vertex_Buffer;
window.Graphics_Addresses = window.tiny_graphics.Graphics_Addresses = Graphics_Addresses;

window.Scene_Component = window.tiny_graphics.Scene_Component = Scene_Component;
window.Canvas_Widget = window.tiny_graphics.Canvas_Widget = Canvas_Widget;
